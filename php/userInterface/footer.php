<footer>
    <div id=footerTop class=shadow>
        <p class=tel><span data-section='footer' data-value='phone'>Telefono:</span> 22959873</p>
    ...
    <div class=copyright>
        <p>2023©VIAUY</p>
        <p data-section='footer' data-value='copyright'>Todos los derechos reservados</p>
    </div>
</footer>